        ...
        <div>
            ...
            <div className="bg-image">
                <div className="bg-white">
                    <div className="bg-name"><h1>CLAIRE-ALINE HAESTIE</h1></div>
                </div>
                <div className="bg-acc"><video style={{ opacity: isVideoLoaded ? 1 : 0 }} autoPlay playsInline loop muted step="0.1"><source src={video} type='video/mp4'/></video></div>
            </div>
            <div className="scroll scroll1"></div>
            <div className="scroll scroll2"></div>
            <div className="full_height_acc">
                <div className="languages">
                    <h2>{fr ? "Technologies abordées en formation et en entreprise :" : "Technologies studied at university and at work"}</h2>
                    <div className="flex2">
